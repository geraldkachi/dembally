    ...
    <div>
      ...
      <div>
        ...
        <div>
          ...
          <div className="relative object-cover w-full h-0 sm:h-max bg-no-repeat bg-cover bg-center mx-auto bg-[url('/faqsecond.svg')] bg-black bg-opacity-100 opacity-100">
