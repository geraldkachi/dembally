...
const Footer = () => {
    ...
    return (
        <div className='bg-[#181101]'>
            <footer className=" lg:grid lg:grid-cols-5 bg-[#181101]">
                <div className="   lg:col-span-2 lg:h-full flex items-center flex-col">
                    <img
                    ...
                    <div className="flex items-center gap-3 mt-5 text-white px-3">
