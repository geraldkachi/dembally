import DemballyFoot from '../..//assets/svg/DEMBALLY..svg'
const Footer = () => {
    const date = new Date()
    return (
        <div className='bg-[#181101]'>
            <footer className=" lg:grid lg:grid-cols-5 gap-4 bg-[#181101] max-w-7xl mx-auto">
                <div className="lg:col-span-2 h-full flex items-center flex-col justify-center">
                    ...
                    <div className="flex items-center gap-3 md:gap-10 mt-5 md:mt-20  text-white px-3">
                    ...
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                        <div>
                            <p>
                                ...
                                <a
                                    href="#"
                                    className="block text-2xl font-medium text-white hover:opacity-75 sm:text-3xl mt-10"
                                >
                                    0816 448 2813
                                </a>
                            </p>
                        ...
                        <div className="grid grid-cols-1 gap-10 text-white">
                            <div className="">
                                ...
                                <nav className="mt-6 text-base">
                                    Haven of Peace, Plot 2, block 128b, Remi Olowude Way, After Pinnacle petrol station, Marwa Bus stop, Oniru, Lekki.
                                </nav>
                            </div>
                            <div className="">
                                {/* <hr className='bg-white my-3 md:my-5' /> */}
...
{/* <p className='text-xs  sm:text-base text-[#FFFFFF] opacity-50 my-3 whitespace-nowrap'>©  {date.getFullYear()} Dembally </p> */ }
